...
class Random_Forest():
    ...
    def __init__(self, n_trees=100, max_depth=10, min_pop=1, seed=0):
        """
        Initializes a Random_Forest instance
        """
        self.numpy_predicts = []
        self.target = None
    ...
    def predict(self, explanatory):
        """
        Returns the most frequent prediction across all trees
        """
    ...
    def fit(self, explanatory, target, n_trees=100, verbose=0):
        """
        Trains n_trees decision trees on the given data
        """
        self.target = target
    ...
    def accuracy(self, test_explanatory, test_target):
        """
        Returns the accuracy of the forest on the given data
        """
        return np.sum(
